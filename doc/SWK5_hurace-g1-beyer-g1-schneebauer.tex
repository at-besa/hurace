...
\begin{document}
	...
	\begin{itemize}
		...
		\lstinputlisting[language=Java]{../Dal/Interface/IRaceDao.cs}
		\item{IRaceDataDao}
		\lstinputlisting[language=Java]{../Dal/Interface/IRaceDataDao.cs}
		\item{IRaceTypeDao}
		\lstinputlisting[language=Java]{../Dal/Interface/IRaceTypeDao.cs}
		\item{ISkierDao}
		\lstinputlisting[language=Java]{../Dal/Interface/ISkierDao.cs}
		\item{ISplittimeDao}
		\lstinputlisting[language=Java]{../Dal/Interface/ISplittimeDao.cs}
		\item{IStartListDao}
		\lstinputlisting[language=Java]{../Dal/Interface/IStartListDao.cs}
	\end{itemize}
